...
export const getViewRecipeRoute = pgr({ recipeNick: true }, ({ recipeNick }) => `/recipies/${recipeNick}`);
export const getEditRecipeRoute = pgr({ recipeNick: true }, ({ recipeNick }) => `/recipies/${recipeNick}/edit`);
